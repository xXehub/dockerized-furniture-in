            ...
            <div class="product-main">
               ...
               <div class="product-grid">
                           ...
                           <div class="showcase">
                              <div class="showcase-banner">
                                 ...
                                 <div class="showcase-content">
                                    ...
                                    <div class="price-box">
                                    <input type="number" name="qty" class="showcase" min="1" max="99" onkeypress="if(this.value.length == 2) return false;" value="1">
                                    <button type="submit" value="perbarui" class="btn btn-wishlist" name="add_to_cart"><i class="fa-solid fa-cart-shopping"></i></button>
                                    ...
                                    <!-- <input type="submit" value="hapus" onclick="return confirm('hapus dari wishlist?');" class="btn btn-wishlist" name="delete"> -->
                                    </div>
                                 </div>
                  ...
                  <?php
                     ...
                     echo '<p class="empty">belum ada barang yang di wishlist!</p>';
                  }
                  ?>
               </div>
            </div>
