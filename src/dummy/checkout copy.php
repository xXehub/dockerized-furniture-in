                           ...
                           ?>
                                 ...
                                 <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                       <img src="uploaded_img/<?= $fetch_cart['image']; ?>" alt="Gambar lur" width="75" height="75" class="showcase-img">
                                    </a>
                                    <div class="showcase-content">
                                       <a class="showcase-category"> <?= $fetch_cart['name']; ?> <a class="showcase-title">(<?= 'Rp.' . $fetch_cart['price'] . ',00 x ' . $fetch_cart['quantity']; ?>)</a> </a>
                                    </div>
                                 </div>
                           <?php
                              }
